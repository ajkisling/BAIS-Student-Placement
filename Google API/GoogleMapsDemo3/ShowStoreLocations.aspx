<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpage.master" AutoEventWireup="false" CodeFile="ShowStoreLocations.aspx.vb" Inherits="ShowStoreLocations" %>

<asp:Content runat="server" ID="headContent" ContentPlaceHolderID="head">
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
    <script type="text/javascript" src="Scripts/GoogleMapHelpers.js"></script>
</asp:Content>
